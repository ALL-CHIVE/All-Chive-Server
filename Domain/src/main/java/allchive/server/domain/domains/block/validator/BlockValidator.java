...
import allchive.server.domain.domains.block.exception.exceptions.BlockNotFoundException;
...
public class BlockValidator {
    ...
    public void validateExist(Long blockFrom, Long blockUser) {
        if (!blockAdaptor.queryBlockExistByBlockFromAndBlockUser(blockFrom, blockUser)) {
            throw BlockNotFoundException.EXCEPTION;
        }
    }
}
