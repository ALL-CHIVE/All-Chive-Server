...
public class DeletedObjectResponse {
    ...
    @Builder
    private DeletedObjectResponse(List<ContentResponse> contents, List<ArchivingResponse> archivings) {
        this.contents = contents;
        this.archivings = archivings;
    }

    public static DeletedObjectResponse of(List<ArchivingResponse> archivings, List<ContentResponse> contents) {
        return DeletedObjectResponse.builder()
